...
const Jobs = () => {
  ...
  const hobbiesList = ['Nowe technologie oraz gadżety elektroniczne', 'Psychologia biznesu i marketingu', 'Gra na gitarze, technologia muzyczna', 'Uczestnictwo w biegach oraz maratonach', 'Literatura faktu, psychologia oraz biograficzna']

  return (
    <div>
        <div className="container">
      <ul> {hobbiesList.map(hobbiesList => {
